    ...
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
      ...
      <div class="w3-row-padding w3-padding-32" style="margin:0 -16px">
       ...
       <div class="w3-third w3-margin-bottom">
           <img src="sidemirrors/1.jpeg" alt="New York" style="width:100%" >
          <div class="w3-container w3-white">
            ...
            <div class="w3-third w3-margin-bottom">
                <img src="sidemirrors/11.jpeg" alt="New York" style="width:100%" >
          <div class="w3-container w3-white">
            <p><b>Sidemirrors</b></p>
            <p class="w3-opacity"></p>
          ...
          <div class="w3-container w3-white">
            ...
            <img src="sidemirrors/14.jpeg" alt="New York" style="width:100%" >
          <div class="w3-container w3-white">
            <p><b>Sidemirrors</b></p>
            <p class="w3-opacity"></p>
            ...
            <img src="sidemirrors/3.jpeg" alt="New York" style="width:100%" >
          <div class="w3-container w3-white">
            <p><b>Sidemirrors</b></p>
            <p class="w3-opacity"></p>
                    ...
                    <div class="w3-third w3-margin-bottom">
              <img src="sidemirrors/4.jpeg" alt="New York" style="width:100%" >
          <div class="w3-container w3-white">
            <p><b>Sidemirrors</b></p>
            <p class="w3-opacity"></p>
                  ...
                  <div class="w3-third w3-margin-bottom">
              <img src="sidemirrors/8.jpeg" alt="New York" style="width:100%" >
          <div class="w3-container w3-white">
            <p><b>Sidemirrors</b></p>
            <p class="w3-opacity"></p>
