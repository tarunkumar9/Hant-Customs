...
<div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
 ...
 <!-- alloys -->
  <div class="w3-black" id="tour">
   ...
   <div class="w3-third w3-margin-bottom">
       <img src="headlights/12.jpeg" alt="San Francisco" style="width:100%" >
 ...
 <p><b>Headlights</b></p>
            <p class="w3-opacity"></p>
             ...
             <div class="w3-third w3-margin-bottom">
                 <img src="headlights/2.jpeg" alt="San Francisco" style="width:100%" >
          <div class="w3-container w3-white">
 <p><b>Headlights</b></p>
            <p class="w3-opacity"></p>
            ...
            <img src="headlights/3.jpeg" alt="San Francisco" style="width:100%" >
          <div class="w3-container w3-white">
 <p><b>Headlights</b></p>
            <p class="w3-opacity"></p>
          </div>
           ...
           <div class="w3-third w3-margin-bottom">
               <img src="headlights/6.jpeg" alt="San Francisco" style="width:100%" >
          <div class="w3-container w3-white">
 <p><b>Headlights</b></p>
            <p class="w3-opacity"></p>
        ...
        <div class="w3-third w3-margin-bottom">
               <img src="headlights/8.jpeg" alt="San Francisco" style="width:100%" >
          <div class="w3-container w3-white">
 <p><b>Headlights</b></p>
            <p class="w3-opacity"></p>
          ...
          <div class="w3-third w3-margin-bottom">
               <img src="headlights/9.jpeg" alt="San Francisco" style="width:100%" >
          <div class="w3-container w3-white">
 <p><b>Headlights</b></p>
            <p class="w3-opacity"></p>
        ...
        <div class="w3-third w3-margin-bottom">
            <img src="headlights/images (18).jpeg" alt="San Francisco" style="width:100%" >
          <div class="w3-container w3-white">
 <p><b>Headlights</b></p>
            <p class="w3-opacity"></p>
          </div>
                ...
                <div class="w3-third w3-margin-bottom">
            <img src="headlights/images (23).jpeg" alt="San Francisco" style="width:100%" >
          <div class="w3-container w3-white">
 <p><b>Headlights</b></p>
            <p class="w3-opacity"></p>
          </div>
                  ...
                  <div class="w3-third w3-margin-bottom">
            <img src="headlights/images (27).jpeg" alt="San Francisco" style="width:100%" >
          <div class="w3-container w3-white">
 <p><b>Headlights</b></p>
            <p class="w3-opacity"></p>
          </div>
                ...
                <div class="w3-third w3-margin-bottom">
            <img src="headlights/images (28).jpeg" alt="San Francisco" style="width:100%" >
          <div class="w3-container w3-white">
 <p><b>Headlights</b></p>
            <p class="w3-opacity"></p>
          </div>
                ...
                <div class="w3-third w3-margin-bottom">
            <img src="headlights/images (30).jpeg" alt="San Francisco" style="width:100%" >
          <div class="w3-container w3-white">
 <p><b>Headlights</b></p>
            <p class="w3-opacity"></p>
          </div>
                ...
                <div class="w3-third w3-margin-bottom">
                    <img src="headlights/images (33).jpeg" alt="San Francisco" style="width:100%" >
          <div class="w3-container w3-white">
 <p><b>Headlights</b></p>
            <p class="w3-opacity"></p>
          </div>
 ...
 <p><b>Headlights</b></p>
            <p class="w3-opacity"></p>
                ...
                <div class="w3-third w3-margin-bottom">
                    <img src="headlights/images (42).jpeg" alt="San Francisco" style="width:100%" >
          <div class="w3-container w3-white">
 <p><b>Headlights</b></p>
            <p class="w3-opacity"></p>
          </div>
                ...
                <div class="w3-third w3-margin-bottom">
                    <img src="headlights/images (44).jpeg" alt="San Francisco" style="width:100%" >
          <div class="w3-container w3-white">
 <p><b>Headlights</b></p>
            <p class="w3-opacity"></p>
          </div>
                ...
                <div class="w3-third w3-margin-bottom">
                    <img src="headlights/images (49).jpeg" alt="San Francisco" style="width:100%" >
          <div class="w3-container w3-white">
 <p><b>Headlights</b></p>
            <p class="w3-opacity"></p>
          </div>
                ...
                <div class="w3-third w3-margin-bottom">
                    <img src="headlights/images (50).jpeg" alt="San Francisco" style="width:100%" >
          <div class="w3-container w3-white">
 <p><b>Headlights</b></p>
            <p class="w3-opacity"></p>
          </div>
                ...
                <div class="w3-third w3-margin-bottom">
                    <img src="headlights/images (51).jpeg" alt="San Francisco" style="width:100%" >
          <div class="w3-container w3-white">
 <p><b>Headlights</b></p>
            <p class="w3-opacity"></p>
          </div>
                ...
                <div class="w3-third w3-margin-bottom">
                    <img src="headlights/images (55).jpeg" alt="San Francisco" style="width:100%" >
          <div class="w3-container w3-white">
 <p><b>Headlights</b></p>
            <p class="w3-opacity"></p>
          </div>
