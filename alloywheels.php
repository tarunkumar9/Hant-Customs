    ...
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
      ...
      <div class="w3-row-padding w3-padding-32" style="margin:0 -16px">
        ...
        <div class="w3-third w3-margin-bottom">
            <img src="alloywheels/re10.jpeg" alt="New York" style="width:100%" >
         ...
         <div class="w3-third w3-margin-bottom">
             <img src="alloywheels/re12.jpeg" alt="New York" style="width:100%" >
          <div class="w3-container w3-white">
            <p><b>Wheel's</b></p>
            <p class="w3-opacity"></p>
           ...
           <div class="w3-third w3-margin-bottom">
               <img src="alloywheels/re14.jpeg" alt="New York" style="width:100%" >
          <div class="w3-container w3-white">
            <p><b>Wheel's</b></p>
            <p class="w3-opacity"></p>
          ...
          <div class="w3-container w3-white">
           ...
           <div class="w3-third w3-margin-bottom">
               <img src="alloywheels/re3.jpeg" alt="New York" style="width:100%" >
          <div class="w3-container w3-white">
            <p><b>Wheel's</b></p>
            <p class="w3-opacity"></p>
          ...
          <div class="w3-third w3-margin-bottom">
               <img src="alloywheels/re5.jpeg" alt="New York" style="width:100%" >
          <div class="w3-container w3-white">
            <p><b>Wheel's</b></p>
            <p class="w3-opacity"></p> 
          </div>
                 ...
                 <div class="w3-third w3-margin-bottom">
               <img src="alloywheels/re6.jpeg" alt="New York" style="width:100%" >
          <div class="w3-container w3-white">
            <p><b>Wheel's</b></p>
            <p class="w3-opacity"></p> 
          </div>
                 ...
                 <div class="w3-third w3-margin-bottom">
               <img src="alloywheels/re7.jpeg" alt="New York" style="width:100%" >
          <div class="w3-container w3-white">
            <p><b>Wheel's</b></p>
            <p class="w3-opacity"></p> 
          </div>
                 ...
                 <div class="w3-third w3-margin-bottom">
               <img src="alloywheels/re9.jpeg" alt="New York" style="width:100%" >
          <div class="w3-container w3-white">
            <p><b>Wheel's</b></p>
            <p class="w3-opacity"></p> 
          </div>
                 ...
                 <div class="w3-third w3-margin-bottom">
                     <img src="alloywheels/rx1.jpeg" alt="New York" style="width:100%" >
          <div class="w3-container w3-white">
            <p><b>Wheel's</b></p>
            <p class="w3-opacity"></p> 
          </div>
              ...
              <div class="w3-third w3-margin-bottom">
                     <img src="alloywheels/rx2.jpeg" alt="New York" style="width:100%" >
          <div class="w3-container w3-white">
            <p><b>Wheel's</b></p>
            <p class="w3-opacity"></p> 
          </div>
              ...
              <div class="w3-third w3-margin-bottom">
                     <img src="alloywheels/rx3.jpeg" alt="New York" style="width:100%" >
          <div class="w3-container w3-white">
            <p><b>Wheel's</b></p>
            <p class="w3-opacity"></p> 
          </div>
              ...
              <div class="w3-third w3-margin-bottom">
                     <img src="alloywheels/rx4.jpeg" alt="New York" style="width:100%" >
          <div class="w3-container w3-white">
            <p><b>Wheel's</b></p>
