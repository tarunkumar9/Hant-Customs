...
<div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="margin-top:46px">
 ...
 <div class="w3-third w3-margin-bottom">
     <img src="handels/11.jpeg" alt="Paris" style="width:100%" >
          <div class="w3-container w3-white">
           ...
           <div class="w3-third w3-margin-bottom">
               <img src="handels/12.jpeg" alt="Paris" style="width:100%" >
          <div class="w3-container w3-white">
           <p><b>Handel's</b></p>
            <p class="w3-opacity"></p>
          ...
          <div class="w3-container w3-white">
           <p><b>Handel's</b></p>
            ...
            <img src="handels/2.jpeg" alt="Paris" style="width:100%" >
          <div class="w3-container w3-white">
           <p><b>Handel's</b></p>
            <p class="w3-opacity"></p>
            ...
            <img src="handels/3.jpeg" alt="Paris" style="width:100%" >
          <div class="w3-container w3-white">
           <p><b>Handel's</b></p>
            <p class="w3-opacity"></p>
          ...
          <div class="w3-third w3-margin-bottom">
              <img src="handels/4.jpeg" alt="Paris" style="width:100%" >
          <div class="w3-container w3-white">
           <p><b>Handel's</b></p>
            <p class="w3-opacity"></p>
          ...
          <div class="w3-third w3-margin-bottom">
              <img src="handels/5.jpeg" alt="Paris" style="width:100%" >
          <div class="w3-container w3-white">
           <p><b>Handel's</b></p>
            <p class="w3-opacity"></p>
          ...
          <div class="w3-third w3-margin-bottom">
              <img src="handels/6.jpeg" alt="Paris" style="width:100%" >
          <div class="w3-container w3-white">
           <p><b>Handel's</b></p>
            <p class="w3-opacity"></p>
          ...
          <div class="w3-third w3-margin-bottom">
              <img src="handels/7.jpeg" alt="Paris" style="width:100%" >
          <div class="w3-container w3-white">
           <p><b>Handel's</b></p>
            <p class="w3-opacity"></p>
          ...
          <div class="w3-third w3-margin-bottom">
              <img src="handels/8.jpeg" alt="Paris" style="width:100%" >
          <div class="w3-container w3-white">
           <p><b>Handel's</b></p>
            <p class="w3-opacity"></p>
